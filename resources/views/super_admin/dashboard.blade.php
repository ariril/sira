    ...
    <div class="container-px py-6">
        ...
        <div class="mt-6 p-4 rounded-xl border">
            ...
            @if($kinerja['periode_aktif'])
                ...
                <p class="text-sm">Total remunerasi periode:
                    <span class="font-medium">{{ number_format($kinerja['total_remunerasi_periode'] ?? 0, 0, ',', '.') }}</span>
                </p>
                <p class="text-sm">Penilaian pending:
                    <span class="font-medium">{{ $kinerja['penilaian_pending'] }}</span>
                </p>
            @else
