<x-app-layout title="Edit Aturan Kriteria 360">
    <x-slot name="header">
        <h1 class="text-2xl font-semibold text-slate-800">Edit Aturan Kriteria 360</h1>
    </x-slot>

    <div class="container-px py-6">
        <div class="bg-white rounded-2xl shadow-sm border border-slate-100 p-6">
            <form method="POST" action="{{ route('admin_rs.criteria_rater_rules.update', $item) }}" class="space-y-6">
                @csrf
                @method('PUT')
