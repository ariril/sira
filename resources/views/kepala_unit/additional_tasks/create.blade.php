        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-100 p-6">
            ...
            >
                ...
                <div>
                    ...
                    <x-ui.input type="number" step="0.01" name="bonus_amount" x-model="bonus" x-bind:disabled="points && points > 0" />
                </div>
                <div>
                    <label class="block text-sm font-medium text-slate-600 mb-1">
                        Poin
                    ...
                    <x-ui.input type="number" step="0.01" name="points" x-model="points" x-bind:disabled="bonus && bonus > 0" />
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <p class="mt-1 text-xs text-slate-500">Opsional, maksimal 10 MB.</p>
                </div>
                <div>
