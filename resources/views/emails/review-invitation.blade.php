...
<head>
    ...
    <title>Survei Kepuasan Pelayanan RSUD MGR. Gabriel Manek SVD Atambua</title>
</head>
    ...
    <div style="max-width:640px;margin:0 auto;padding:24px;">
        <div style="background:#ffffff;border:1px solid #e2e8f0;border-radius:16px;overflow:hidden;">
            <div style="padding:20px 24px;border-bottom:1px solid #e2e8f0;">
                ...
                <div style="font-size:13px;color:#64748b;margin-top:4px;">Survei Kepuasan Pelayanan</div>
            </div>
            ...
            <div style="padding:24px;">
                ...
                <p style="margin:0 0 14px 0;font-size:14px;line-height:1.6;color:#0f172a;">
                    Terima kasih telah menggunakan layanan kami di <strong>{{ $unit }}</strong> MGR. Gabriel Manek SVD Atambua. 
