    ...
    public function index(Request $request): View
    {
        ...
        if ($unitId && Schema::hasTable('additional_task_claims') && Schema::hasTable('additional_tasks')) {
            $builder = DB::table('additional_task_claims as c')
                ...
                ->selectRaw('c.id, c.status, c.submitted_at, c.reviewed_at, c.review_comment, c.awarded_points, c.result_note, c.result_file_path, u.name as user_name, t.title as task_title, ap.name as period_name')
